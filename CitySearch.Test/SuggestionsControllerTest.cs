...
public class SuggestionsControllerTest
{
    ...
    [Fact]
    public void Get_ReturnListOrderedByDescendingResultScore()
    {
        (float, float) location = (0.0f, 0.0f);
        City city1 = new("Montr", "CA", 1.0f, 1.0f);
        City city2 = new("Montre", "CA", 2.0f, 2.0f);
        City city3 = new("Montrea", "CA", 3.0f, 3.0f);
        ScoredCity scoredCity1 = new(city1, 0.5f);
        ScoredCity scoredCity2 = new(city2, 1/3f);
        ScoredCity scoredCity3 = new(city3, 0.25f);
        ...
        List<JsonObject> result = suggestionsController.Get("Mont");
